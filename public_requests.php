...
<main class="public-request-shell public-hub">
    ...
    <section class="public-form-choices">
        ...
        <a class="public-choice access-choice" href="/system_monitoring/public_access_request.php">
            <span class="public-choice-icon">
                <svg viewBox="0 0 24 24"><rect x="3" y="11" width="18" height="10" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            </span>
            <span class="public-choice-state">Public form</span>
            <h2>DMIS Access Request</h2>
            <p>Request DMIS module access by providing your name, dealer, department, DMIS username, module, and reason.</p>
