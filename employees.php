...
<div class="card mb-18">
    <div class="card-body">
        <form method="get" class="filters employee-filters">
            ...
            <div class="form-group"><label for="company">Dealers</label><select id="company" name="company"><option value="">All Dealers</option><?php foreach (ID_COMPANIES as $code => $label): ?><option value="<?= e($code) ?>" <?= $companyCode === $code ? 'selected' : '' ?>><?= e($code) ?></option><?php endforeach; ?></select></div>
